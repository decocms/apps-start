import shopify, { Props as ShopifyProps } from "../shopify/mod";
import vnda, { Props as VNDAProps } from "../vnda/mod";
import vtex, { Props as VTEXProps } from "../vtex/mod";
import wake, { Props as WakeProps } from "../wake/mod";
import website, { Props as WebsiteProps } from "../website/mod";
import manifest, { Manifest } from "./manifest.gen";
const bgYellow = (s: string) => s; // stub: no terminal colors in production
import { type App, type FnContext } from "../../shopify/mod";
...
export { onBeforeResolveProps } from "../website/mod";

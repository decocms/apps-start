...
import { waitForWorkflowCompletion } from "../../workflows/utils/awaiters";
import type { VTEXNotificationPayload } from "../actions/trigger";
import type { AppManifest } from "../mod";
import { Workflow, WorkflowContext } from "../../shopify/mod";
import { type WorkflowGen } from "../shopify/mod";
interface Props {
  product: Workflow[];
}

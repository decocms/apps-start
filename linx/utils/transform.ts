...
} from "./types/gridProductsJSON";
import { NavigationInfo as ProductNavigation } from "./types/shared";
import {
  Item as LinxProductFromJSON,
  Model as LinxProductGroupProductJSON,
  WebPage as ProductWebPage,
} from "./types/productJSON";
import {
...
} from "./types/suggestionsJSON";
import type { Facet } from "./types/shared";
import { ProductAuction } from "./types/auctionJSON";
import { Model as ProductAuctionDetail } from "./types/auctionDetailJSON";
import { Product as LinxProductGetByIdJSON } from "./types/productByIdJSON";
import { Associations } from "./types/associationsJSON";
import { Auction } from "./types/auctionAPI";
